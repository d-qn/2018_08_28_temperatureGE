...
```{r teaser heatmap, eval = F}
  ...
  jpeg("output/geneva_1753_2017_tiles.jpeg", width = 1800, height = 800, quality = 300)
  print(tiles)
  dev.off()
  ...
  theme(
    ...
    legend.position = "top",
    legend.key.width = unit(fontSize / 3.5, "lines"),
  ...
  scale_fill_gradient2(name = "Écart",
     ...
     labels = paste0(c("-2", "-1", " 0", "+1", "+2"), "°C"),
      low = "#1c5263", high = "#c91d34", mid = "#ffefff",
      #low = tam_dpal[1], high = tam_dpal[13], mid = tam_dpal[7],
      guide = guide_colourbar(title.vjust = 0))
    
  jpeg("output/geneva_1753_2017_tilesM.jpeg", width = 1000, height = 1600, quality = 300)
  print(tilesM)
  dev.off()
